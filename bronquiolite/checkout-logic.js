// ========================================
// CHECKOUT LOGIC - Fisioterapia Respiratória na Bronquiolite Viral Aguda
// ========================================

var VALID_COUPONS = ["SELECIONADON4"];
var ORIGINAL_PRICE = 997.00;
var DISCOUNT_PERCENTAGE = 0.80;
...
window.paymentApproved = function() {
    ...
    if (USE_SDK) {
        window.location.href = 'https://finalizando-inscricao.site/bronquiolite/obrigado.html';
    } else {
        window.location.href = 'https://finalizando-inscricao.site/bronquiolite/obrigado.html?transactionId=' + (formData.transactionId || '') + '&amount=' + (formData.valorFinal || ORIGINAL_PRICE);
    }
};
        ...
        try {
            if (USE_SDK) {
                var config = {
                    ...
                    items: [{ name: 'Fisioterapia Respiratória na Bronquiolite Viral Aguda', price: price, quantity: 1 }]
                };
                ...
                var payload = {
                    ...
                    items: [{ name: 'Fisioterapia Respiratória na Bronquiolite Viral Aguda', quantity: 1, unit_price: toCents(price) }]
                };
